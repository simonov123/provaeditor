...
public class runtime {
	...
	private String csvpath= System.getProperty("user.home") + "/";
	...
	public String setlang(Strings ss) throws IOException {
		...
		File langfile=new File(System.getProperty("user.home") + "/lang.txt");
	...
	public void infosaver(String pat, String filename2, String name, int size) throws IOException, CsvValidationException {
		File update = new File(System.getProperty("user.home") + "/" + filename2 + ".csv");
		CSVWriter wr2 = new CSVWriter(new FileWriter(System.getProperty("user.home") + "/" + filename2 + ".csv"));
		String[] filer= {""};
		Integer siz=size;
	...
	public Font getfontinfo(String filename2, String pat) throws CsvValidationException, IOException {
		File getinfo = new File(System.getProperty("user.home") + "/" + filename2 + ".csv");

		if (getinfo.exists()==true)
		{
			CSVReader r1 = new CSVReader(new FileReader(System.getProperty("user.home") + "/" + filename2 + ".csv"));
